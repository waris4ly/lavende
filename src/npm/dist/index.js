...
class Queue {
    ...
    utils = {
        ...
        totalDuration: () => {
            return this.tracks.reduce((acc, cur) => acc + (cur.info.length || 0), this.current?.info.length || 0);
        },
...
class LavendeManager extends events_1.EventEmitter {
    players = new Map();
    sendToShard;
    client;
    nodeManager = {
...
(function (DebugEvents) {
    ...
    DebugEvents["SocketCleanupError"] = "SocketCleanupError";
    ...
    DebugEvents["PlayerDestroyFail"] = "PlayerDestroyFail";
    DebugEvents["PlayerChangeNodeFailNoEligibleNode"] = "PlayerChangeNodeFailNoEligibleNode";
    DebugEvents["PlayerChangeNodeFail"] = "PlayerChangeNodeFail";
