...
export declare class Player extends EventEmitter {
    ...
    getPosition(): number;
    isPaused(): boolean;
    getLyrics(skipTrackSource?: boolean): Promise<any>;
}
...
export declare function loadLyrics(encodedTrack: string, skipTrackSource?: boolean): Promise<any>;
export declare function loadLyricsBySearch(title: string, artist: string): Promise<any>;
